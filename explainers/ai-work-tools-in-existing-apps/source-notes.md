...
- 2026-07-19: Updated the guide to emphasize workflow-based evaluation, connected research workspaces, in-app review gates, and disclosure controls. Added newer evidence from OpenAI’s scorecard, Google’s Gemini Notebook update, GitHub’s AI security detections, Google’s ad transparency labels, and app-native examples from Canva and Notion.
