...
<section class="posts products-showcase" id="products" aria-labelledby="products-title">
  ...
  <article class="product-card product-card-featured product-bundle">
    <div class="product-copy">
      <p class="product-kicker">Best value · £58.80 including VAT</p>
      ...
      <p class="bundle-saving"><strong>Save £32.40</strong> compared with buying the four core Gates separately, plus receive the exclusive bonus add-on.</p>
      <p class="price-tax-note">UK price including VAT.</p>
      ...
      <div class="report-actions">
        <a href="https://payhip.com/b/cmklU" class="payhip-buy-button button" data-theme="green" data-product="cmklU">Get All Four Gates + Free Bonus — £58.80</a>
      </div>
    </div>
  ...
  <div class="gate-grid" aria-label="Individual Clearforge AI Gates">
    <article class="product-card gate-card">
      ...
      <p class="product-kicker">Gate 1 · £22.80 including VAT</p>
      <h3>Opportunity Gate</h3>
      <p>Decide whether AI belongs in the task before time, money or sensitive information is committed.</p>
      <p class="price-tax-note">UK price including VAT.</p>
      <a href="https://payhip.com/b/4rcSt" class="payhip-buy-button button button-secondary" data-theme="green" data-product="4rcSt">Buy Opportunity Gate — £22.80</a>
    </article>
    ...
    <article class="product-card gate-card">
      ...
      <p class="product-kicker">Gate 2 · £22.80 including VAT</p>
      <h3>Workflow Control Gate</h3>
      <p>Define the workflow, ownership and human checkpoints before AI-assisted work moves forward.</p>
      <p class="price-tax-note">UK price including VAT.</p>
      <a href="https://payhip.com/b/qBPip" class="payhip-buy-button button button-secondary" data-theme="green" data-product="qBPip">Buy Workflow Control Gate — £22.80</a>
    </article>
    ...
    <article class="product-card gate-card">
      ...
      <p class="product-kicker">Gate 3 · £22.80 including VAT</p>
      <h3>Output Release Gate</h3>
      <p>Check evidence, privacy, ownership and readiness before AI-assisted work is published or sent.</p>
      <p class="price-tax-note">UK price including VAT.</p>
      <a href="https://payhip.com/b/pkSEY" class="payhip-buy-button button button-secondary" data-theme="green" data-product="pkSEY">Buy Output Release Gate — £22.80</a>
    </article>
    ...
    <article class="product-card gate-card">
      ...
      <p class="product-kicker">Gate 4 · £22.80 including VAT</p>
      ...
      <p class="price-tax-note">UK price including VAT.</p>
      <a href="https://payhip.com/b/rgFXP" class="payhip-buy-button button button-secondary" data-theme="green" data-product="rgFXP">Buy Outcome Review Gate — £22.80</a>
    </article>
  </div>
</section>
<!-- /CLEARFORGE_PRODUCTS -->`;
