...
function rebaseEpisode(item) {
  ...
  return {
    ...
    related_article_url: `${BASE}/posts/${encodeURIComponent(itemDateSlug)}.html`,
    related_feature_url: `${BASE}/features/${encodeURIComponent(itemDateSlug)}.html`
  };
}
