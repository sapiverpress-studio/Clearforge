...
function buildDailyVideos() {
  ...
  for (const [sourcePath, filename] of [
    ["@ffmpeg/ffmpeg/dist/umd/ffmpeg.js", "video-engine.js"],
    ["@ffmpeg/ffmpeg/dist/umd/814.ffmpeg.js", "video-worker.js"],
