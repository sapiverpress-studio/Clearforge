...
if (uniqueOrder.length < 3 || uniqueOrder.some((index) => index < 0 || index >= stories.length)) {
  throw new Error("Podcast did not select at least three valid distinct stories.");
}
