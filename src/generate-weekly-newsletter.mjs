...
if (fs.existsSync(draftsDir)) {
  for (const date of fs.readdirSync(draftsDir).filter(inWindow).sort()) {
    ...
    entries.push({
      ...
      takeaway: clean(data.practical_takeaway || ""),
