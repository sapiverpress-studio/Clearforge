...
async function main() {
  ...
  const response = await client.responses.create({
    ...
    input: [
      { role: "system", content: "Preserve every source and story coverage_lane and topic_category from the morning edition. Preserve each source evidence_basis and URL without alteration. Human-impact context must remain traceable to its underlying speech, interview, survey, organisation, case study or credible reporting; never turn a TikTok lead into evidence." },
