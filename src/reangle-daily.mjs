...
function editorialTheme(dateValue) {
  ...
  const themes = {
    Monday: { slug: "weekend-roundup", title: "Weekend roundup", focus: "The most important confirmed AI developments from the weekend and their practical consequences.", instruction: "Select only the strongest developments. Explain what changed, who it affects and what deserves attention this week." },
    Tuesday: { slug: "ai-at-work", title: "AI at work", focus: "AI at work: daily tasks, teams, productivity, research, writing, support, admin, meetings and practical workplace use.", instruction: "Prioritise what creators, small operators and small businesses can test in real work this week." },
    Wednesday: { slug: "everyday-life", title: "AI in everyday life", focus: "Life-admin and personal usefulness: learning, household planning, accessibility, personal knowledge management, family logistics, study, note-taking and everyday problem solving.", instruction: "Keep the angle practical and careful. Avoid medical, legal or financial advice." },
    Thursday: { slug: "systems-automation", title: "Systems and automation", focus: "Systems, automation, agents, reliability, review loops, handoffs, repeatable processes, governance, failure points and human accountability.", instruction: "Emphasise what should and should not be automated, and where human review belongs." },
    Friday: { slug: "new-tools-stacks-workflows", title: "New tools, stacks and workflows", focus: "Emerging tools and the combinations of models, apps, APIs, media, documents, databases, scheduling and publishing systems they enable.", instruction: "Explain what is available now, how the pieces fit together, what remains uncertain and whether the workflow genuinely saves work." },
    Saturday: { slug: "prediction-outlook", title: "Prediction and outlook", focus: "Evidence-based outlook using the week’s confirmed developments.", instruction: "Label forecasts as forecasts. Ask what might reasonably follow and who may be affected, without presenting predictions as facts." },
    Sunday: { slug: "recap-preparation", title: "Recap and preparation", focus: "Recap the strongest developments of the week and prepare the reader for the following week.", instruction: "Separate confirmed outcomes from still-open questions and give one practical preparation step." }
  };
...
async function main() {
  ...
  const response = await client.responses.create({
    ...
    input: [
      { role: "system", content: "Preserve every source and story coverage_lane, topic_category, event_date and freshness_status from the morning edition. Preserve each source evidence_basis, freshness_basis and URL without alteration. Never relabel background material as current. Human-impact context must remain traceable to its underlying speech, interview, survey, organisation, case study or credible reporting; never turn a TikTok lead into evidence." },
      { role: "system", content: "You are the Clearforge alternate-angle editor. Reuse the supplied verified source material, but create a genuinely different editorial edition. Do not invent new source facts. Do not claim this is new reporting. Make the article, social post and video script feel meaningfully different from a standard news recap. Preserve every material access restriction from the source edition, including eligibility, limited programmes, account tier, region, preview/beta status, managed deployment and whether access is self-service. Preserve the day’s editorial theme while applying the selected alternate lens. Do not introduce or amplify any claim that is unresolved in the source edition. Every story must retain support from the cited source material. A considered question is evidence-led scrutiny, not manufactured controversy: ask about a plausible consequence, trade-off, missing safeguard or affected group only when the supplied evidence supports raising that question. Clearforge's current product system covers Opportunity, Workflow Control, Output Release, Outcome Review and Agent Connection. Connect to only the relevant stage and only when the evidence genuinely supports it. Never force a product connection onto unrelated news." },
      { role: "system", content: `CONTENT RULE OF ONE:
- Use one lead story, one affected audience, one useful consequence, one practical three-step check and one natural next action.
- Other supplied stories may appear only when they directly corroborate or clarify the lead problem. Do not produce a list of disconnected updates.
- Explicitly label conclusions that go beyond the source as Clearforge interpretation.
- Never use comparative or universal wording such as "faster than", "depends on" or "proves" unless the source directly establishes it.` },
