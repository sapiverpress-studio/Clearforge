...
if (!Array.isArray(data.sources) || data.sources.length < 3) throw new Error("At least three surviving sources are required.");
...
console.log(`Rebuilt edition from ${data.sources.length} verified surviving stories.`);
