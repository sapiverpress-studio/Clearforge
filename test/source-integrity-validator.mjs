...
const assertions = [
  ...
  [podcast.includes('requiredStoryCount = Math.min(3, verifiedCount)'), "Podcast must prefer a broad multi-story briefing while retaining a verified fallback."],
  ...
  [workflow.indexOf("Generate daily broad AI podcast script") < workflow.indexOf("Install FFmpeg"), "Podcast text and claim checks must complete before media work."],
